...
import com.example.phalurao.kotlinedemo.plursight.DemoMainActivity
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list_view.setOnClickListener(object :View.OnClickListener{
        ...
        plursight_view.setOnClickListener(object :View.OnClickListener{
            override fun onClick(v: View?) {
                val intent = Intent(applicationContext, DemoMainActivity::class.java)
                startActivity(intent)
            }
        ...
        load_webview.setOnClickListener(object :View.OnClickListener {
            override fun onClick(v: View?) {
        ...
        ui_component.setOnClickListener(object :View.OnClickListener{
            override fun onClick(v: View?) {
        ...
        custom_recy.setOnClickListener(object:View.OnClickListener{
            override fun onClick(v: View?) {
